...
export default function ExtensionPage() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            a.href = url
            a.download = 'antigravity-extension-v1.0.0.zip'
    ...
    const features = [
        {
            ...
            title: 'Anında Prompt Üretimi',
            description: 'Herhangi bir web sayfasında metin seçin, tek tıkla optimize promptlar üretin',
        },
        {
                    ...
                    <div className="flex flex-col items-center gap-5">
                        ...
                        {downloaded && (
                            ...
                            >
                                ...
                                antigravity-extension-v1.0.0.zip başarıyla indirildi!
                            </motion.div>
                        )}
                    </div>
                </motion.div>
