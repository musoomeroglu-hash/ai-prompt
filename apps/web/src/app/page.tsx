...
export default function Home() {
  ...
  if (!session) {
    ...
    if (!loading) {
      // Show landing page with Email & Google Sign In instead of redirecting
      return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-black relative overflow-hidden text-center px-4">
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center w-full">
            ...
            <div className="w-full max-w-sm bg-neutral-900/50 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-white text-black font-semibold py-3 px-4 rounded-xl hover:bg-neutral-100 transition-all duration-200"
                >
