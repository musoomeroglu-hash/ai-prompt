            ...
            <div className="flex items-center justify-center p-8 bg-[#030303] text-white">
                <div className="w-full max-w-[420px]">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-neutral-400 text-sm">Please enter your details</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                                className="h-12 bg-neutral-900/50 border-neutral-800 focus:border-purple-500 text-white placeholder:text-neutral-500"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    onBlur={() => setIsTyping(false)}
                                    required
                                    className="h-12 pr-10 bg-neutral-900/50 border-neutral-800 focus:border-purple-500 text-white placeholder:text-neutral-500"
                                />
                                <button
                                    type="button"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                <Checkbox id="remember" className="border-neutral-700 data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600" />
                                <Label
                                    htmlFor="remember"
